...
-- 16. 创建默认组合配置
INSERT INTO currency_portfolio_config (portfolio_name, description, target_allocation, rebalance_threshold, max_single_currency, risk_level, is_active) VALUES
('默认组合', '系统默认的多币种投资组合', '{"BTC": 0.4, "ETH": 0.3, "SOL": 0.2, "ADA": 0.1}', 5.0, 50.0, 'MEDIUM', true)
ON CONFLICT DO NOTHING;

-- 完成提示
SELECT '多币种系统数据库更新完成！' as status; 